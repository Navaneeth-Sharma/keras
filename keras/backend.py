...
def binary_focal_crossentropy(
  ...
  According to the reference https://arxiv.org/pdf/1708.02002.pdf, it helps to
  apply a focal factor to down-weight easy examples and focus more on hard
  examples. By default, the focal tensor is computed as follows:

  `focal_factor` = (1 - `output`)**`gamma` for class 1
  `focal_factor` = `output`**`gamma` for class 0
  where `gamma` is a focusing parameter. When `gamma` = 0, this function is
  is equivalent to the binary crossentropy.
